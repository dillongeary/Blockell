...
export let tupleHelper;
tupleHelper = function() {
    this.itemCount_ = 2;
    this.updateShape_();
}

export let tupleCreateWithContainer;
tupleCreateWithContainer = {
    init: function() {
...
export let tupleCreateWithItem
tupleCreateWithItem = {
    init: function() {
